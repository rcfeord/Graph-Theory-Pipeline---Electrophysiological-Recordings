...
%% USER IMPUT REQUIRED FOR THIS SECTION 
...
xlsfilename = 'RecordingsList.xlsx'; % name of excel spreadsheet
...
Params.priorAnalysisDate = '27Sep2021';
...
if Params.priorAnalysis==0 || Params.priorAnalysis==1 && Params.startAnalysisStep<4
    ...
    for  ExN = 1:length(ExpName)
        ...
        if Params.priorAnalysis==1 && Params.startAnalysisStep==3
            path = strcat(Params.priorAnalysisPath,'/ExperimentMatFile/');
            path(strfind(savepath,'\'))='/'; cd(path)
